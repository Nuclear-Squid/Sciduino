...
La carte BEP effectue toutes les fonctions attendues par la carte NI-6212. Elle pourrait effectuer des tâches supplémentaires comme l’auto-contrôle du banc de test, sans dépendre du PC externe. La dépendance à NI-DAQ est résolue, et l’électronique du banc d’essais pneumatique est désormais entièrement conçue par RBI.
...
- [RTIC] gère très bien la concurrence (mais pas encore les multicœurs) ;
...
Les MCU de Raspberry Pi, [rp2040] et [rp2350], basés sur des doubles cœurs Cortex M0+ et M33 respectivement, sortent du lot avec un ratio performances/coût *très* compétitif.
...
Le Raspberry Pi RP2040 aurait convenu à *tous* les projets RBI des 10 dernières années. Il fonctionne très bien avec l’IDE Arduino et permet d’utiliser des environnements alternatifs :
...
J’ai plus appris en quatre mois de stage que pendant tout mon cycle ingénieur : de la théorie à la pratique il y a un monde, et l’équipe m’a bien aidé à monter en compétence. Moi qui doutais de mon orientation, je suis désormais certain d’avoir choisi la bonne voie en visant la double compétence informatique et électronique.
